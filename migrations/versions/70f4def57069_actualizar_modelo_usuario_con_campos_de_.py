"""Actualizar modelo Usuario con campos de autenticacion y bloqueo

Revision ID: 70f4def57069
Revises: 
Create Date: 2025-05-26 17:38:38.898993
...
def upgrade():
    ...
    op.drop_table('version_documentos')
    op.drop_table('failed_jobs')
    op.drop_table('historial_actividads')
